...
internal sealed class EcsTaskMetadataBaseAddressProvider : IEcsTaskMetadataBaseAddressProvider
{
    ...
    /// <summary>
    ///     The exception message used when the <c>ECS_CONTAINER_METADATA_URI</c> environment variable value is invalid.
    /// </summary>
    private const string INVALID_ERROR = "The ECS_CONTAINER_METADATA_URI environment variable is not a valid URL.";

    /// <summary>
    ///     The exception message used when the <c>ECS_CONTAINER_METADATA_URI</c> environment variable value is null or
    ///     empty.
    /// </summary>
    ...
    ///     <c>ECS_CONTAINER_METADATA_URI</c> environment variable. This variable is defined when running in a supported
    ///     ECS environment.
    /// </summary>
