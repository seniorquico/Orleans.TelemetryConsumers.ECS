...
/// <summary>
///     An ECS Task Metadata Endpoint client factory. These clients may be used to get the Docker container statistics.
/// </summary>
internal sealed class EcsTaskMetadataClientFactory : IEcsTaskMetadataClientFactory
{
    ...
    /// <exception cref="InvalidOperationException">If the service provider is not correctly configured.</exception>
