...
{
    public sealed class EcsTaskHostEnvironmentStatisticsTest :
        IDisposable
    {
        ...
        public void GetInitialProperties()
        {
            ...
            // Act
            this.statistics = new EcsTaskHostEnvironmentStatistics(
                clientFactoryMock.Object,
                new Logger<EcsTaskHostEnvironmentStatistics>(this.loggerFactory));
        ...
        public void ParticipateInClusterClientLifecycle()
        {
            ...
            lifecycleMock.Verify(
                o => o.Subscribe(
                    "Orleans.TelemetryConsumers.ECS.EcsTaskHostEnvironmentStatistics",
