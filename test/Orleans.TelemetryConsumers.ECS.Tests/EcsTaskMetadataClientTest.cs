...
{
    public sealed class EcsTaskMetadataClientTest :
        IDisposable
    {
        ...
        public async Task GetContainerStatsAsyncWithErrorResponseReturnsNull(HttpStatusCode statusCode)
        {
            ...
            var client = new EcsTaskMetadataClient(
                httpClient,
                baseAddressProviderMock.Object,
                serializerProvider,
                new Logger<EcsTaskMetadataClient>(this.loggerFactory));
