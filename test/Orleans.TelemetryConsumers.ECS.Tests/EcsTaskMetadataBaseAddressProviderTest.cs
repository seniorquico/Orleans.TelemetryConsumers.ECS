...
{
    public sealed class EcsTaskMetadataBaseAddressProviderTest :
        BaseAddressEnvironmentVariableTest
    {
        public EcsTaskMetadataBaseAddressProviderTest(BaseAddressEnvironmentVariableFixture fixture)
            : base(fixture)
        {
        }
